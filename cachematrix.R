...
# 1st function: makeCacheMatrix takes a given 2 X 2 matrix and also provides a list containing function to: 
# 1. set matrix 
# 2. get matrix
...
makeCacheMatrix <- function(x = matrix()) {
  ...
  getinverse <- function() inv  # if tested before cashSolve function will return "null" else will return matrix inverse. 
  # test with a$getinverse() 
